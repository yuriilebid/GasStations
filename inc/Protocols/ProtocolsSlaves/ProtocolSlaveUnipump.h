#ifndef PTS2_0_PROTOCOLSLAVEUNIPUMP_H
#define PTS2_0_PROTOCOLSLAVEUNIPUMP_H

#include "ProtocolSlave.h"

class ProtocolSlaveUnipump : public ProtocolSlave {
private:
public:
    std::unique_ptr<UniversalCmd> parseCmd(const std::vector<unsigned char>& cmd) override { return {}; };
    ...
    std::vector<unsigned char> preparePacketVec(std::shared_ptr<UniversalState> cmd, int addr) override { return {}; };
...
#endif //PTS2_0_PROTOCOLSLAVEUNIPUMP_H
